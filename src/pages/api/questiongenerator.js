...
function shuffleString(inputString) {
  const characters = inputString.split(""); // Convert string to an array of characters
  shuffleArray(characters); // Shuffle the array of characters
